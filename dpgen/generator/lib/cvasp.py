...
vasperrslist = ['tet', 'inv_rot_mat', 'brmix', 'subspacematrix', 'tetirr',
                'incorrect_shift', 'real_optlay', 'rspher', 'dentet',
                'triple_product', 'rot_matrix', 'brions', 'pricel', 'zpotrf',
                'amin', 'zbrent', 'pssyevx', 'eddrmm', 'edddav',
                'grad_not_orth', 'nicht_konv', 'zheev', 'elf_kpar', 'elf_ncl',
                'rhosyg', 'posmap', 'point_group']

handlers = [VaspErrorHandler(errors_subset_to_catch=vasperrslist), FrozenJobErrorHandler(), StdErrHandler(), NonConvergingErrorHandler(),
